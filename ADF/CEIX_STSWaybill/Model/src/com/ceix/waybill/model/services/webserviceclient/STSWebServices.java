...
//import com.oracle.xmlns1.apps.scm.doo.decomposition.orderdetailservices.orderinformationservice.DocumentReference;
//import com.oracle.xmlns1.apps.scm.doo.decomposition.orderdetailservices.orderinformationservice.Order;
//import com.oracle.xmlns1.apps.scm.doo.decomposition.orderdetailservices.orderinformationservice.Line;
//import com.oracle.xmlns1.apps.scm.doo.decomposition.orderdetailservices.orderinformationservice.OrderInformationService;
//import com.oracle.xmlns1.apps.scm.doo.decomposition.orderdetailservices.orderinformationservice.OrderInformationService_Service;
//import com.oracle.xmlns1.apps.scm.doo.decomposition.orderdetailservices.orderinformationservice.OrderRequest;
...
import com.oracle.xmlns.apps.scm.inventory.materialtransactions.pendingtransactions.stagedinventorytransactionservicev2.StagedInventoryTransactionLot;
import com.oracle.xmlns.apps.scm.inventory.materialtransactions.pendingtransactions.stagedinventorytransactionservicev2.StagedInventoryTransactionSerial;
...
public class STSWebServices {
    ...
    //@WebServiceRef
    //private static OrderInformationService_Service orderInformationService_Service;
...
//private static String PROPERTY_FILE = "com/ceix/waybill/model/WebService.properties";
  ...
  //  SecurityPolicyFeature[] m_securityFeature =
    ...
    //private static final String servicePassword = "Test";
    ...
    public String callPickWaveService(String p_orderNo,
                                      String p_sourceSystemName,
                                      String p_shipFromOrganization,
                                      String p_orderType,
                                      String p_releaseRule) {
        ...
        try {
            ...
            PickWaveService pickWaveService =
                pickWaveService_Service.getPickWaveServiceSoapHttpPort(m_securityFeature);
            ...
            JAXBElement<String> sourceSystemName =
                objectFactory.createPickingBatchSourceSystemName(p_sourceSystemName);
            JAXBElement<String> orderNum =
                objectFactory.createPickingBatchOrder(p_orderNo);
            //JAXBElement<String> releaseStatus = objectFactory.createPickingBatchReleaseStatus("E");
            JAXBElement<String> createShipments =
                objectFactory.createPickingBatchCreateShipments("N");
            JAXBElement<String> shipFromOrganization =
                objectFactory.createPickingBatchShipFromOrganization(p_shipFromOrganization);
            JAXBElement<String> orderType =
                objectFactory.createPickingBatchOrderType(p_orderType);
            JAXBElement<String> autoConfirmPicks =
                objectFactory.createPickingBatchAutoConfirmPicks("Y");
            ...
            createBatchReturn =
                    pickWaveService.processCreatePickBatch(apiVersionNumber,
                                                           null, p_releaseRule,
                                                           null,
                                                           pickingBatchDtls);
            pickingBatchNum =
                    createBatchReturn.getPickingBatchName().getValue();
    ...
    public String callProcessReleasePickBatch(String pickBatch,
                                              String p_releaseMode) {
        ...
        try {
            ...
            releaseBatchReturn =
                    pickWaveService.processReleasePickBatch(apiVersionNumber,
                                                            "", pickBatch,
                                                            p_releaseMode);
    ...
    public String callProcessCreateUpdateShipmentService(String ShipmentName,
                                                       String p_shipFromOrganization,
                                                       String p_customerNumber,
                                                       String p_shipToPartySiteNumber,
                                                       String p_dumpdate,
                                                       BigDecimal p_weightTons,
                                                       String carrier) {
        String status = null;
        try {
            ...
            JAXBElement<String> shipment =
                objectFactory.createShipmentInformationShipment(ShipmentName);
            JAXBElement<String> shipFromOrganization =
            ...
            JAXBElement<XMLGregorianCalendar> dumpedDate = null;
            JAXBElement<XMLGregorianCalendar> planDate = null;
            try{
                SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");
                Date date = df.parse(p_dumpdate);                
                cal.setTime(date);
                DatatypeFactory datatypeFactory = DatatypeFactory.newInstance();
                XMLGregorianCalendar shipDate = 
                               datatypeFactory.newXMLGregorianCalendar(cal);
                dumpedDate = objectFactory.createShipmentInformationInitialShipDate(shipDate);
            ...
            JAXBElement<BigDecimal> grossWeight =
                objectFactory.createShipmentInformationGrossWeight(p_weightTons);
            JAXBElement<BigDecimal> netWeight =
                objectFactory.createShipmentInformationNetWeight(p_weightTons);
            JAXBElement<String> weightUOM =
                objectFactory.createShipmentInformationWeightUOM("TON");
            ...
            shipmentInformation.setInitialShipDate(dumpedDate);
            ...
            shipmentInformation.setWaybill(shipment);
            //Added as part of JIRA ORACLE-6301 to default Shipping Method
            ...
            ShipmentResponse shipmentResponse =
                shipmentService.processCreateUpdateShipment(apiVersionNumber,
                                                            "", "CREATE",
                                                            shipmentInformation);
            //                List<ErrorMessage> ShipmentResponseMessageList = shipmentResponse.getMessage();
            //                ErrorMessage updateShipmentMessage = new ErrorMessage();
            //                 if(null!=ShipmentResponseMessageList.get(0))
            //                  updateShipmentMessage = ShipmentResponseMessageList.get(0);
            ...
            //System.out.println(" #4. processCreateUpdateShipment : Shipment =====>>>>> " +
              //                 shipmentResponse.getShipment().getValue());
            if (shipmentResponse.getReturnStatus().getValue().equals("ERROR")) {
    ...
    public String callManageShipmentAssignments(String shipmentName,
        ...
        try {
            ...
            ManageShipmentAssignmentResponse manageShipmentAssignmentResponse =
                shipmentLineService.manageShipmentAssignments(new BigDecimal(1.0),
                                                              null,
                                                              shipmentLineList,
                                                              "ASSIGN",
                                                              shipmentName);
            ...
            if (manageShipmentAssignmentResponse.getReturnStatus().getValue().equals("ERROR")) {
                List<Message> messageList =
                    manageShipmentAssignmentResponse.getMessage();
    ...
    public Long callSplitShipmentLine(Long shipmentLineNum, BigDecimal weightTons){
        ...
        try{
            ...
            SplitShipmentLineResponse splitShipmentLineResponse =
                shipmentLineService.splitShipmentLine(new BigDecimal(1.0), "",
                                                      shipmentLineNum,
                                                      weightTons,
                                                      null);
            ...
            if (null != splitShipmentLineResponse.getShipmentLine().getValue())
                shipmentLineFromSplitLine =
                        Long.valueOf(splitShipmentLineResponse.getShipmentLine().getValue());
            status = splitShipmentLineResponse.getReturnStatus().getValue().toString();
            //System.out.println(" #6. splitShipmentLine RESPONSE ========>>>> " +
              //                 splitShipmentLineResponse.getReturnStatus().getValue().toString());
            if(splitShipmentLineResponse.getReturnStatus().getValue().equals("ERROR")) {
    ...
    public UpdateShipmentLinesResponse callUpdateShipmentLine(List<ShipmentLineInformation> p_shipmentLineInformationList){
        ...
        try{
            ...
            updateShipmentLinesResponse =
                shipmentLineService.updateShipmentLines(new BigDecimal(1.0),
                                                        "",
                                                        p_shipmentLineInformationList,
    ...
    public String callprocessShippingCost(String p_cost,
                                         BigDecimal p_Amount, Long p_shipmentLineFromSplitLine){
        String status = null;
        try{
            ShipmentLineService shipmentLineService = this.getShipmentLineWebService();
            ...
            if(ShippingCostResponse.getReturnStatus().getValue().equals("ERROR")) {
    ...
    public String callProcessShipmentAction(String shipmentName, String shipConfirmRule) {
        ...
        try {
            ShipmentService shipmentService = this.getShipmentWebService();
           ShipmentResponse shipmentResponse = shipmentService.processShipmentAction(apiVersionNumber, null, "CONFIRM", shipmentName, null, null, null, null, null,
                                                                                     null, shipConfirmRule, null, null, null, null);
            List<ErrorMessage> messagelist = shipmentResponse.getMessage(); 
    ...
    /*public OrderDetailsResponseBean callGetOrderDetails(String sourceTransSystem, String sourceTransNumber, String headItemNumber) {
        OrderDetailsResponseBean orderDetailsResponseBean = new OrderDetailsResponseBean ();
        try {
            orderInformationService_Service = new OrderInformationService_Service();              
            ...
            String serviceEndpoint = getResourceFromProperties("OrderInfoEndpointURL");
             ...
             requestContext.put (WSBindingProvider.USERNAME_PROPERTY,serviceUsername);    
             requestContext.put (WSBindingProvider.PASSWORD_PROPERTY,servicePassword);         
                 com.oracle.xmlns1.apps.scm.doo.decomposition.orderdetailservices.orderinformationservice.ObjectFactory objectFactory = new com.oracle.xmlns1.apps.scm.doo.decomposition.orderdetailservices.orderinformationservice.ObjectFactory();
                 ...
                 Order orderresult = orderresponse.get(0);
                 
                 //System.out.println("Header RequestingBusinessUnitIdentifier ========>>> "+orderresult.getRequestingBusinessUnitIdentifier().getValue());
                 
                 orderDetailsResponseBean.setRequestingBusinessUnitIdentifier(orderresult.getRequestingBusinessUnitIdentifier().getValue());
                 int i = 0;
                 //protected List<Line> orderLine;
                 OrderLineBean orderLineBean=new OrderLineBean();
                 List<OrderLineBean> orderLineBeanList = new ArrayList();
                 List<Line> odrLineList = orderresult.getOrderLine();
                 Iterator<Line> orderLineListIter = odrLineList.iterator();
                 while(orderLineListIter.hasNext()) {
                     Line orderLineData = orderLineListIter.next();
                     orderLineBean.setRequestedSupplierNumber(orderLineData.getRequestedSupplierNumber().getValue());
                     orderLineBean.setRequestedSupplierName(orderLineData.getRequestedSupplierName().getValue());
                     orderLineBean.setRequisitionInventoryOrganizationIdentifier(orderLineData.getRequisitionInventoryOrganizationIdentifier().getValue());
                     orderLineBean.setBuyerIdentifier(orderLineData.getBuyerIdentifier().getValue());
                     orderLineBean.setProductIdentifier(orderLineData.getProductIdentifier().getValue());
                     
                     
                     orderDetailsResponseBean.setOrderLineList(orderLineBeanList);
                     //System.out.println("9# orderLine no: "+i+", RequestedSupplierNumber                    ========>>> "+orderLineData.getRequestedSupplierNumber().getValue());
                     //System.out.println("The fullfill numb is"+orderLineData.getFulfillLineNumber().getValue());
                     //System.out.println("The Fullfillstatus is :"+orderLineData.getStatusCode().getValue());
                     //System.out.println("9# orderLine no: "+i+", RequestedSupplierName                      ========>>> "+orderLineData.getRequestedSupplierName().getValue());
                     //System.out.println("9# orderLine no: "+i+", RequisitionInventoryOrganizationIdentifier ========>>> "+orderLineData.getRequisitionInventoryOrganizationIdentifier().getValue());
                     //System.out.println("9# orderLine no: "+i+", BuyerIdentifier                            ========>>> "+orderLineData.getBuyerIdentifier().getValue());
                     //System.out.println("9# orderLine no: "+i+", ProductIdentifier                          ========>>> "+orderLineData.getProductIdentifier().getValue());              
                     //System.out.println();  
                     String line_break = null;
                     String drop_break = null;
                     if("AWAIT_SHIP".equals(orderLineData.getStatusCode().getValue())){
                         //System.out.println("I am here inside If AWAIT_SHIP");
                         line_break = "YES";
                     }
                     
                     List<DocumentReference> lineDocumentReferenceList = orderLineData.getLineDocumentReference();
                     Iterator<DocumentReference> lineDocumentReferenceListIter = lineDocumentReferenceList.iterator();
                     while(lineDocumentReferenceListIter.hasNext()) {
                         //DocumentReference documentReference1 = lineDocumentReferenceListIter.next();
                         //System.out.println("The refe type:"+documentReference1.getDocumentReferenceType().getValue());
                         DocumentReference documentReference = lineDocumentReferenceListIter.next();
                         //System.out.println("The refe after type:"+documentReference.getDocumentReferenceType().getValue());
                         //DocumentReference documentReferencenext = lineDocumentReferenceListIter.next();
                         //System.out.println("The refe after2 type:"+documentReferencenext.getDocumentReferenceType().getValue());
                         if ("DROPSHIP_PO_REFERENCE".equals(documentReference.getDocumentReferenceType().getValue())){
                             orderLineBean.setDocumentUserKey(documentReference.getDocumentUserKey().getValue());
                             orderLineBean.setDocumentLineUserKey(documentReference.getDocumentLineUserKey().getValue());
                             //System.out.println("orderLine no: "+i+", LineDocumentReference - DocumentUserKey ========>>> "+documentReference.getDocumentUserKey().getValue());
                             //System.out.println("orderLine no:"+i+", LineDocumentReference - DocumentLineUserKey ========>>> "+documentReference.getDocumentLineUserKey().getValue());
                             drop_break = "YES";
                             break;
                         }     
                         System.out.println("The refe end");
                     }
                     if ("YES".equals(line_break) && "YES".equals(drop_break)){
                         //System.out.println("I am here inside If line_break drop_break");
                         orderLineBeanList.add(orderLineBean);
                         break;
                     }
                     //System.out.println("The refe end end");
                     orderLineBeanList.add(orderLineBean);
                     i++;
                 }
        }catch(Exception ex) {
   ...
   private void initProperties() {
    ...
    public String callRunReport(String salesOrderNumbr) {
        ...
        try {
            System.out.println("salesOrderNumbr on Run Report: "+salesOrderNumbr);
            ...
            System.out.println("Delivery DetailId on Run Report: "+deliveryDetaiilId);
